...
public class PadActivity extends UartInterfaceActivity {
    ...
    /*public void seekBar() {
        ...
        textview = findViewById(R.id.textView2);
        textview.setText(getString(R.string.speed, vsb.getProgress()));
        vsb.setOnSeekBarChangeListener(
                new SeekBar.OnSeekBarChangeListener() {
                    int progressVal;
                    @Override
                    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                        progressVal = progress;
                        textview.setText(getString(R.string.speed, progress));
                    }
                    ...
                    public void onStopTrackingTouch(SeekBar seekBar) {
                        textview.setText(getString(R.string.speed, progressVal));
                        String data = Integer.toString(progressVal);
                        ByteBuffer buffer2 = ByteBuffer.allocate(data.length()).order(java.nio.ByteOrder.LITTLE_ENDIAN);
                        buffer2.put(data.getBytes());
                        sendDataWithCRC(buffer2.array());
                    }
                }
        );
    }*/
